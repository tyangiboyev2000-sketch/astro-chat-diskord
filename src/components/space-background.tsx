      ...
      {stars.map((s, i) => (
        <span
          ...
          style={{
            ...
            width: `${s.size}px`,
            height: `${s.size}px`,
            boxShadow: `0 0 ${s.size * 5}px oklch(0.95 0.03 240 / 0.9)`,
...
export function SpaceBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      />
      <StarLayer count={90} seed={1} maxSize={2} duration={200} opacity={0.8} />
      <StarLayer count={55} seed={40} maxSize={3} duration={130} opacity={0.8} />
